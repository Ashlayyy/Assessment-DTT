    ...
    <section class="leftSide">
      ...
      <section class="detailCard" v-if="house.location != ''">
        ...
        <div class="detailCardInfo">
          <section class="titleClass">
            <div class="titleRow" :class="house.madeByMe ? 'madeByMeRow' : ''">
              ...
              <div class="buttonsDivider">
                ...
                <favoriteButton @click="toggleFavorite(house.id)" :active="contains(house.id)" />
              </div>
            </div>
          </section>
          <div class="locationRow row">
            <span class="locationCollum collum">
              <img
                src="../../assets/icons/DTTIcons/ic_location@3x.png"
                alt="Location icon"
                class="locationIcon icon"
              />
              <p class="locationText textParagraphs">
          ...
          <div class="secondRow row">
            <span class="priceCollum collum">
              <img
                src="../../assets/icons/DTTIcons/ic_price@3x.png"
                alt="Price icon"
            ...
            <span class="sizeCollum collum">
              <img
                src="../../assets/icons/DTTIcons/ic_size@3x.png"
                alt="Size icon"
                class="sizeIcon icon"
              />
            ...
            <span class="yearCollum collum">
              <img
                src="../../assets/icons/DTTIcons/ic_construction_date@3x.png"
          ...
          <div class="thirdRow row">
            <span class="collum bedCollum">
              <img
                src="../../assets/icons/DTTIcons/ic_bed@3x.png"
                alt="Bed icon"
                class="bedIcon icon"
              />
            ...
            <span class="collum bathCollum">
              <img
                src="../../assets/icons/DTTIcons/ic_bath@3x.png"
                alt="Bath icon"
                class="bathIcon icon"
              />
            ...
            <span class="collum garageCollum">
              <img
                src="../../assets/icons/DTTIcons/ic_garage@3x.png"
                alt="Garage icon"
        ...
        <div class="recommended mobile">
          <h2 class="header">Recommended for you</h2>
          <div class="divider">
  ...
  <appModel v-if="showModal" :showModal="showModal">
    ...
    <template v-slot:body>
      <div class="buttonDivider buttons">
        <button @click="deleteHouse(house.id)" class="yesButton">Yes, delete</button>
        <button @click="showModal = false" class="cancelButton">Go back</button>
      </div>
    </template>
  </appModel>
</template>
